...
/**2016-7-19 19:44:00 yiyuanwei edit*/
	if(_d0.iconCls){
		$("<span class=\"icon\"></span>").addClass(_d0.iconCls).prependTo(_d1);
	} else {
...
$("<a href=\"javascript:void(0)\" class=\"datebox-clean\"></a>").html(opts.cleanText).appendTo(_756);/**新增清除按钮 2016-7-14*/
$("<a href=\"javascript:void(0)\" class=\"datebox-close\"></a>").html(opts.closeText).appendTo(_756);
_756.find(".datebox-current,.datebox-close,.datebox-clean").hover(function(){
...
_757(this,q);
}},currentText:"Today",closeText:"Close",okText:"Ok",cleanText:"Clean",formatter:function(date){  /* 添加清空按钮 */
