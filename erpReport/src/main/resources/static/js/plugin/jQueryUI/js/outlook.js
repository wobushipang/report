...
function tabCloseEven() {
	$(function(){
		$(".tabs-inner:first").unbind("contextmenu");
		$(".tabs-inner:first").bind("contextmenu",function(e){
			return false;
		});
	});
...
//    });
    ...
    $('#mm-tabcloseright').click(function() {
        ...
        $('.tabs-selected:not(:first) span').each(function(i, n) {
                ...
                $(function() {
                    ...
                    $('#loginOut').click(function() {
                        $.messager.confirm('系统提示', '您确定要退出本次登录吗?', function(r) {
                            if (r) {
                                location.href = CONTEXT_PATH+"/login.do?method=logout";
                            }
                        });
                    })
                });
