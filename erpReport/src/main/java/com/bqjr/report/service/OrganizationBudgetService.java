 ...
 * @FileName OrganizationBudgetService 
 * @author wei.huang02
 * @Date 2017年10月30日 上午9:24:50 
 *****************************************************************************/
...
/**
 * @ClassName OrganizationBudgetService.java
 * @Description 
 * @author wei.huang02
 * @Date 2017年10月30日 上午9:24:50
 * @since JDK 1.8
 */
public interface OrganizationBudgetService {

	Map<String, Object> getOrganizationBudgetList(int pageNum, int pageSize, SearchCondition condition);
